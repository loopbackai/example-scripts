# Adapted from https://github.com/SeanNesdoly/eliza Sean Nesdoly 29th Jan 2017
    ...
    "hello": [
        ...
        [
            ...
            [
                ...
                "Salutations, human.",
                "Have we not already introduced ourselves?",
            ],
        ],
        False,
    ],
    ...
    "my": [
        ...
        [
            ...
            [
                ...
                "Does that have anything to do with the previous fact that your {1}?",
            ],
        ],
        True,
    ],
    ...
    for i, token in enumerate(tokens):
        ...
        if token in keywords:
            if not keystack:  # no keys yet, so simply add it in
                ...
                key_rank >= keystack[-1][0]
            ):  # add higher rank key to the top of the stack (end of list)
    ...
    for matched_key in reversed(keystack):
        ...
        for i in range(1, len(matched_key) - 1):
            ...
            if match:
                ...
                reflected_response = response.format(
